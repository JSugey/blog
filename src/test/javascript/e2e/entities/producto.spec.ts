...
describe('Producto e2e test', () => {
    ...
    it('should load Productos', () => {
        ...
        expect(productoComponentsPage.getTitle()).toMatch(/blogApp.producto.home.title/);
    ...
    it('should load create Producto dialog', () => {
        ...
        expect(productoDialogPage.getModalTitle()).toMatch(/blogApp.producto.home.createOrEditLabel/);
