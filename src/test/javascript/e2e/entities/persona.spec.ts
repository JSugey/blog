...
describe('Persona e2e test', () => {
    ...
    it('should load Personas', () => {
        ...
        expect(personaComponentsPage.getTitle()).toMatch(/blogApp.persona.home.title/);
    ...
    it('should load create Persona dialog', () => {
        ...
        expect(personaDialogPage.getModalTitle()).toMatch(/blogApp.persona.home.createOrEditLabel/);
