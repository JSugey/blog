...
describe('NuevaCompra e2e test', () => {
    ...
    it('should load NuevaCompras', () => {
        ...
        expect(nuevaCompraComponentsPage.getTitle()).toMatch(/blogApp.nuevaCompra.home.title/);
    ...
    it('should load create NuevaCompra dialog', () => {
        ...
        expect(nuevaCompraDialogPage.getModalTitle()).toMatch(/blogApp.nuevaCompra.home.createOrEditLabel/);
